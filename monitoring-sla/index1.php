...
$user = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM staff WHERE username='".$_SESSION['username']."'"));
...
if (isset($_POST['submit1'])) {
   ...
   $query_cek = "SELECT * FROM task WHERE nama='$nama' AND task='$task' AND prog='$prog' AND tngl='$tngl'";
   ...
   if (mysqli_num_rows($result_cek) > 0) {
       ...
       $query_insert = "INSERT INTO task (nama, task, prog, deskripsi, tngl, gambare) VALUES ('$nama', '$task', '$prog', '$deskripsi', '$tngl', '$newFileName')";
...
if (isset($_POST['filter'])) {
   $filter = $_POST['filter'];
   $sql = "SELECT * FROM task WHERE tngl = '$filter'";
 } else {
	...
	<div class="modal-content">
		...
		<form method="post" action="" enctype="multipart/form-data">
			<div class="field">
				...
				<input id="nama" name="nama" value="<?php echo $_SESSION['username']; ?>" readonly><br>
			</div>
